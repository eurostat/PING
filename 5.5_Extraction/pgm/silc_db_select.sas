/** 
## silc_db_select {#sas_silc_db_select}
...
%macro silc_db_select(time				/* Year of interest										(REQ) */
	...
	/* CDS_CTRYxZONE, CLIB: set the default file of geographical zones/areas */
