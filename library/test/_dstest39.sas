...
%macro _dstest39(lib=, _ds_=, verb=no, force=no);
 	%local _dsn _ilib;
	...
	%if %macro_isblank(_ilib) or &force=yes %then %do;	
		...
		DATA &_ilib..&_dsn;
			...
			geo='BE';  EQ_INC20=50; RB050a=10; output ;
			geo='BE';  EQ_INC20=60; RB050a=10; output ;
			geo='BE';  EQ_INC20=20; RB050a=20; output ;
			geo='BE';  EQ_INC20=10; RB050a=20; output ;
			geo='BE';  EQ_INC20=30; RB050a=20; output ;
			geo='BE';  EQ_INC20=40; RB050a=20; output ;
			geo='IT';  EQ_INC20=10; RB050a=10; output ;
			geo='IT';  EQ_INC20=50; RB050a=10; output ;
			geo='IT';  EQ_INC20=50; RB050a=10; output ;
			geo='IT';  EQ_INC20=30; RB050a=20; output ;
			geo='IT';  EQ_INC20=30; RB050a=20; output ;
			geo='IT';  EQ_INC20=20; RB050a=20; output ;
			geo='IT';  EQ_INC20=50; RB050a=20; output ;
		run;
	%end;
	%else %do;
...
%macro _example_dstest39;
	...
	%work_clean(_dstest39);
%mend _example_dstest39;
