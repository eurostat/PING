...
%macro macro_execute/parmbuff;
	...
	/*
	%let output=%&macro_name(%unquote(&arguments));
	&output
	*/
...
%macro _example_macro_execute;
	...
	%if &var=1 2 c %then 	%put OK: TEST PASSED - Macro test1 found and ran correctly;
	...
	%if &var=1 2 c %then 	%put OK: TEST PASSED - Macro test2 found and ran correctly;
