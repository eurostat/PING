...
%macro obs_geocopy(dsn	/* Input dataset 										(REQ) */
				, igeo
				, ogeo
				, time=
				, lib=
...
%macro _example_obs_geocopy;
	...
	%obs_geocopy(dumber, ES, FR, lib=WORK, replace=YES);
 	%ds_print(dumber, title="All FR data REPLACED by duplicates of AT data");

	%exit:
%mend _example_obs_geocopy;

/* Uncomment for quick testing
options NOSOURCE MRECALL MLOGIC MPRINT NOTES;
%_example_obs_geocopy;
*/
