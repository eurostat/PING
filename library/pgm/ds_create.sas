...
%macro _example_ds_create;
	...
	%ds_create(&_dsn, var=&labels, len=&lengths, type=&types, idsn=&_cds, ilib=WORK);
	...
	%ds_create(&_dsn, var=&labels, len=&lengths, type=&types, idsn=INDICATOR_CONTENTS, ilib=LIBCFG);
