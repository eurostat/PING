...
%let G_PING_SUPPORT=&G_PING_ROOTPATH/5.5_Modules/pension; 
...
%macro _ds_count(ds, _nds_=);
	...
	%let _dirdata=&G_PING_ROOTPATH/5.5_Modules/pension/data;   /* TO CHANGE */
 ...
 */
	%let  _nprg=%list_length(%file_ls(&_dirdata, match=&ds.&_suff, ext=&_ext, beg=yes));
	data _null_;
