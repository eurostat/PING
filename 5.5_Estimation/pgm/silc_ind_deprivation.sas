...
%macro silc_ind_deprivation(survey		/* Type of survey								(REQ) */
	...
	%exit:
%mend silc_ind_deprivation;


%macro _example_silc_ind_deprivation;
	...
	%silc_ind_deprivation(L, &time, &geo);
	...
	%silc_ind_deprivation(L, &time, &geo, &odsn);
	...
	%silc_ind_deprivation(L, &time, &geo, &odsn._1);
	...
	%silc_ind_deprivation(L, &time, &geo, &odsn._2, n_ext=&n_ext);
	DATA &odsn._2;
		 SET &odsn._2;
	     _time=lag1(HB010);  
    run;
	...
	%exit:
%mend _example_silc_ind_deprivation;

/* Uncomment for quick testing
options NOSOURCE MRECALL MLOGIC MPRINT NOTES;
%_example_silc_ind_deprivation;
*/
