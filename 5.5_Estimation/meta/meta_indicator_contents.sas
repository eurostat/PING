...
%mend meta_indicator_contents;


%macro _example_meta_indicator_contents;
	...
	%put;
%mend _example_meta_indicator_contents;

/* Uncomment for quick testing
options NOSOURCE MRECALL MLOGIC MPRINT NOTES;
%_example_meta_indicator_contents;
*/
