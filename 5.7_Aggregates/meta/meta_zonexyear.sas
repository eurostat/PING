...
%macro _example_meta_zonexyear;
	...
	%put;
%mend _example_meta_zonexyear;

/* Uncomment for quick testing
options NOSOURCE MRECALL MLOGIC MPRINT NOTES;
%_example_meta_zonexyear;
*/
